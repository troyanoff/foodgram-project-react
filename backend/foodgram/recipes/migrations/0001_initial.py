    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement_unit', models.CharField(choices=[('кг', 'кг'), ('г', 'г'), ('шт', 'шт'), ('ст. л.', 'ст. л.'), ('ч. л.', 'ч. л.'), ('л', 'л'), ('мл', 'мл'), ('по вкусу', 'по вкусу')], max_length=10, verbose_name='Единица измерения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_favorited', models.BooleanField(default=False, verbose_name='В спистке избранного')),
                ('is_in_shopping_cart', models.BooleanField(default=False, verbose_name='В спистке покупок')),
